const translations = {
    da: {
        ...
        aiProviderCopilot: 'GitHub Copilot',
        openaiApiKey: 'OpenAI API-nøgle:',
        geminiApiKey: 'Google Gemini API-nøgle:',
        geminiModel: 'Gemini Model:',
        loadModels: 'Hent modeller',
        loadingModels: 'Henter modeller...',
        modelsLoaded: 'Modeller hentet',
        modelLoadError: 'Kunne ikke hente modeller',
        copilotApiKey: 'GitHub Copilot API-nøgle:',
        copilotModel: 'Copilot model (valgfrit):',
        apiKey: 'API-nøgle:',
    ...
    en: {
        ...
        modelLoadError: 'Could not load models',
        copilotApiKey: 'GitHub Copilot API key:',
        copilotModel: 'Copilot model (optional):',
        apiKey: 'API key:',
